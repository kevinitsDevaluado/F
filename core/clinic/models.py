...
class Client(models.Model):
    ...
    mobile = models.CharField(max_length=10, default='', null=True, blank=True, verbose_name='Teléfono celular')
    phone = models.CharField(max_length=10, null=True, blank=True, verbose_name='Teléfono convencional',default='')
    address = models.CharField(max_length=500, null=True, blank=True, verbose_name='Dirección')
    birthdate = models.DateField(default=datetime.now, verbose_name='Fecha de nacimiento')
    parish = models.ForeignKey(Parish, on_delete=models.CASCADE, null=True, blank=True, verbose_name='Parroquia', default='')
...
class BreedPet(models.Model):
    type = models.ForeignKey(TypePet, on_delete=models.CASCADE, verbose_name='Tipo de Mascota')
    name = models.CharField(max_length=50, verbose_name='Nombre')
...
class Mascots(models.Model):
    ...
    breed = models.ForeignKey(BreedPet, on_delete=models.CASCADE, verbose_name='Tipo de Raza')
    ...
    def __str__(self):
        return 'Nombre: {} / Dueño: {} / Raza: {} / Tipo: {} / Color: {}'.format(self.name,
...
class Sale(models.Model):
    ...
    mascot = models.ForeignKey(Mascots, on_delete=models.CASCADE)
